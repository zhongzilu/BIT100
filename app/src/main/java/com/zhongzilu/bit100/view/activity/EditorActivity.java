...
import com.zhongzilu.bit100.application.util.FileUtils;
import com.zhongzilu.bit100.presenter.IEditorActivityView;
import com.zhongzilu.bit100.view.base.BaseToolbarActivity;
import com.zhongzilu.bit100.view.fragment.EditorFragment;
import com.zhongzilu.bit100.view.fragment.EditorMarkdownFragment;
import com.zhongzilu.bit100.widget.ExpandableLinearLayout;
import com.zhongzilu.bit100.widget.TabIconView;
...
public class EditorActivity extends BaseToolbarActivity
    ...
    protected EditorFragment mEditorFragment;
    protected EditorMarkdownFragment mEditorMarkdownFragment;
...
//        getAppBar().addView(mExpandLayout);
    ...
    public void onFailure(int errorCode, String message, int flag) {
        switch (flag) {
            default:
                App.showSnackbar(getWindow().getDecorView(), message);
                break;
        }
    }
